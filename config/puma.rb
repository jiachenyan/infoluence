...
# The default is "0, 16".
#
threads_count_min = Integer(ENV['MIN_THREADS'] || 3)
threads_count_max = Integer(ENV['MAX_THREADS'] || 3)
...
#
on_restart do
  puts 'Puma worker shutting restarting...'
...
on_worker_shutdown do
  puts 'Puma worker shutting down...'
  ActiveRecord::Base.connection.disconnect!
end
...
# 500 ms more than rack timeout
worker_timeout (Integer(ENV['RACK_TIMEOUT'] || 25) + 0.5)
